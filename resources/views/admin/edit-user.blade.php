...
@section('content')
                            ...
                            <div class="profile__mobile-tabs-menu dropdown-menu" aria-labelledby="mobile-tabs">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item"><a class="nav-link" id="3-tab" data-toggle="tab"
                                            href="#tab-3" role="tab" aria-controls="tab-3" aria-selected="false">Reviews</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="profile__group">
                                                    ...
                                                    <input id="firstname" type="text" name="firstname"
                                                        class="profile__input" placeholder="John">
                                                </div>
                                            </div>
                                ...
                                <div class="col-12 col-lg-6">
                                    <form action="#" class="profile__form">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="profile__group">
                                                    <label class="profile__label" for="confirmpass">Confirm New
                                                        Password</label>
                                ...
                                <table class="main__table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="main__table-text main__table-text--rate">8.6</div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">67 / 22</div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="main__table-text main__table-text--rate">6.0</div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">44 / 5</div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="main__table-text main__table-text--rate">5.5</div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">8 / 132</div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="main__table-text main__table-text--rate">7.0</div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">6 / 1</div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="main__table-text main__table-text--rate">6.2</div>
                                            </td>
                                            <td>
                                                <div class="main__table-text">13 / 14</div>
                                            </td>
    ...
    <div id="modal-view2" class="zoom-anim-dialog mfp-hide modal modal--view">
        <div class="reviews__autor">
            <img class="reviews__avatar" src="{{asset('assets/admin/img/user.svg')}}" alt="">
