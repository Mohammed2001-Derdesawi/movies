...
<section class="section details">
	<!-- details background -->
	<div class="details__bg" data-bg="{{asset('assets/main/img/home/home__bg.jpg')}}"></div>
									...
									<ul class="comments__list">
										...
										<li class="comments__item">
											<div class="comments__autor">
												<img class="comments__avatar" src="{{asset('assets/main/img/user.svg')}}" alt="">
									...
									<ul class="reviews__list">
										<li class="reviews__item">
											<div class="reviews__autor">
												<img class="reviews__avatar" src="{{asset('assets/main/img/user.svg')}}" alt="">
						...
						<div class="gallery" itemscope>
							<div class="row row--grid">
								...
								<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
									<a href="{{asset('assets/main/img/gallery/project-1.jpg')}}" itemprop="contentUrl" data-size="1920x1280">
										<img src="{{asset('assets/main/img/gallery/project-1.jpg')}}" itemprop="thumbnail" alt="Image description" />
									</a>
								...
								<!-- gallery item -->
								<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
									<a href="{{asset('assets/main/img/gallery/project-2.jpg')}}" itemprop="contentUrl" data-size="1920x1280">
										<img src="{{asset('assets/main/img/gallery/project-2.jpg')}}" itemprop="thumbnail" alt="Image description" />
									</a>
									<figcaption itemprop="caption description">Some image caption 2</figcaption>
								</figure>
								<!-- end gallery item -->
								...
								<!-- gallery item -->
								<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
									<a href="{{asset('assets/main/img/gallery/project-3.jpg')}}" itemprop="contentUrl" data-size="1920x1280">
										<img src="{{asset('assets/main/img/gallery/project-3.jpg')}}" itemprop="thumbnail" alt="Image description" />
									</a>
								...
								<!-- gallery item -->
								<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
									<a href="{{asset('assets/main/img/gallery/project-4.jpg')}}" itemprop="contentUrl" data-size="1920x1280">
										<img src="{{asset('assets/main/img/gallery/project-4.jpg')}}" itemprop="thumbnail" alt="Image description" />
									</a>
								...
								<!-- gallery item -->
								<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
									<a href="{{asset('assets/main/img/gallery/project-5.jpg')}}" itemprop="contentUrl" data-size="1920x1280">
										<img src="{{asset('assets/main/img/gallery/project-5.jpg')}}" itemprop="thumbnail" alt="Image description" />
									</a>
								...
								<!-- gallery item -->
								<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
									<a href="{{asset('assets/main/img/gallery/project-6.jpg')}}" itemprop="contentUrl" data-size="1920x1280">
										<img src="{{asset('assets/main/img/gallery/project-6.jpg')}}" itemprop="thumbnail" alt="Image description" />
									</a>
