...
<!-- Mirrored from dmitryvolkov.me/demo/flixgo2.0/admin/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Mar 2022 10:07:56 GMT -->
<head>
	<meta charset="utf-8">
...
<!-- page 404 -->
<div class="page-404 section--bg" data-bg="{{asset('assets/admin/img/section/section.jpg')}}">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<div class="page-404__wrap">
					<div class="page-404__content">
						...
						<a href="{{route('main')}}" class="page-404__btn">go back</a>
					</div>
				</div>
			</div>
		</div>
