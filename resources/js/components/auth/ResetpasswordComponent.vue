			...
			<div class="col-12">
				<div class="sign__content">
					...
					<form action="#" class="sign__form"  @submit.prevent="formsubmit()"
                     ...
                     <h1 class="text-danger center">Reset Your Password</h1>
                     </div>
						<div class="sign__group">
							<input type="text" class="sign__input" placeholder="Email" required  name="email" disabled  :value="admin.email">
						  <div class="sign__group">
                    <span
                   ...
                   <div class="sign__group">
                    ...
                    >
                        ...
                        :class="{ signupdisabled: isdisabled ||isdisabledvarbutton ||Disabledbuttonwhenloading  }"
                        >Reset Password <div style=" color: #fff;font-size:18px;" v-if="isloading"> <i class="fa fa-spinner fa-spin" style="margin-left:10px;"></i></div>    </button>
...
<script>
export default {
      name:'ResetpasswordCompnent',
      props:['emailadmin','admintoken'],
      ...
      return "signupdisabled";
          ...
          isdisabledvarbutton()
          {
              if(this.validateEmail==undefined && this.validatePassword==undefined && this.validconfirmpasssword==undefined)
              return false
              else return true
          },
           isdisabled() {
               return this.admin.email.length == 0 || this.admin.password.length == 0  ||this.admin.password_confirmation.length ==0;
           },
      ...
      methods:{
           ...
           async formsubmit(event){
               this.isloading=true;
               this.Disabledbuttonwhenloading=true;

                 axios.post('/admin/password/update',this.admin).then((response)=>{

               this.Disabledbuttonwhenloading=false;
